  ...
  <div class="user-wrap" v-if="isLoading">
    <scroller lock-x scrollbar-y :height="iheight+'px'"  :prevent-default="false"  v-ref:scroller>
      <div>
        ...
        <group>
          <cell title="我的钱包" link="/user/wallet" ></cell>
          <cell title="发起的项目" link="/publish/order/list" ></cell>
          <cell title="我的众筹" link="/order/raise" ></cell>
          <cell title="我的互助" link="/order/help" ></cell>
          <cell title="收货地址管理" link="/raise/addr/user" ></cell>
        </group>
      </div>
    </scroller>
  </div>
